...
public interface PostulantesRepository extends JpaRepository<Postulantes, Long>  {
	...
	@Query(value = "select a.id, a.persona_id as personaid,c.abreviatura as tipodocumento, b.apellido_paterno, b.apellido_materno, b.nombre,b.nro_documento,\r\n"
			...
			+ "   b.sexo,b.direccion,b.email,b.fecha_nacimiento,b.celular,b.telefono,b.ubigeo_id, f.nombre as carrera, g.nombre as sede\r\n"
